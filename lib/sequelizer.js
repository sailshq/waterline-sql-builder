...
module.exports = function sequelizer(options) {
  ...
  function buildQueryPiece(fn, expression, query) {
  ...
  // very brittle.
  function buildKnexGroupingFn(expressionGroup, modifier, query) {
    ...
    query[fn].call(query, function buildGroupFn() {
      ...
      //   ║║║╣  ║ ║╣ ╠╦╝║║║║║║║║╣   ├┴┐│││├┤ ┌┴┬┘  ├┤ │ │││││   │ ││ ││││
      //  ═╩╝╚═╝ ╩ ╚═╝╩╚═╩ ╩╩╝╚╝╚═╝  ┴ ┴┘└┘└─┘┴ └─  └  └─┘┘└┘└─┘ ┴ ┴└─┘┘└┘
      function determineFn(_expr, idx) {
  ...
  function processConditionalSet(tokens, nested, expression, modifier, query) {
